...
echo "3. Upgrade transformers and restart (fixes XLM-RoBERTa tokenizer bug):"
echo "   docker exec open-webui pip install --upgrade transformers"
echo "   docker restart open-webui"
echo "4. Watch logs: docker logs -f open-webui"
echo "5. Monitor GPU: watch -n 1 nvidia-smi"
echo ""
